 ...
 * A set of cards created to help artists break creative blocks
 */
...
export type ObliqueStrategy = (typeof obliqueStrategies)[number]

/**
 * Get a random oblique strategy
 */
export function getRandomStrategy(): ObliqueStrategy {
